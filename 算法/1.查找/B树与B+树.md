B树解析：https://www.bilibili.com/video/BV1UC4y1p7zm?from=search&seid=8074364709592511780
...
　　所以，我们为了减少磁盘ＩＯ的次数，就你必须降低树的深度，将“瘦高”的树变得“矮胖”。-- 稀疏索引 -- 多级索引
...
（解释：树阶：树节点最多有多少个子节点，关键字：结点中存放的数据）

（2-3树：3阶树，每个节点最多有三个子节点，每个节点最多放2个key（数据），3-4树：4阶树）

1.根结点至少有两个子女。
2.每个中间节点都包含k-1个元素和k个孩子，其中 ceil（m/2） ≤ k ≤ m  -- （ceil() 向上取整）
...
示例：三阶B树（实际中节点中元素很多）![这里写图片描述](https://img-blog.csdn.net/2018032420113990?watermark/2/text/aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3pfcnlhbg==/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70)
...
最终结果如下图：虽然插入比较麻烦，但是这也能确保Ｂ树是一个自平衡的树![这里写图片描述](https://img-blog.csdn.net/20180324230149255?watermark/2/text/aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3pfcnlhbg==/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70)
...
下面举一个简单的例子：删除元素11.![这里写图片描述](https://img-blog.csdn.net/20180324232514619?watermark/2/text/aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3pfcnlhbg==/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70)
...
原文链接：https://blog.csdn.net/z_ryan/article/details/79685072